...
/// A class that contains all theme configurations for the church management application.
/// Implements "Sacred Minimalism" design with "Warm Sanctuary" color palette.
class AppTheme {
  AppTheme._();

  // Warm Sanctuary Color Palette - Earth-toned colors optimized for Ghana's lighting conditions
  static const Color primaryLight = Color(0xFF2C5F41); // Deep forest green
  static const Color primaryVariantLight =
      Color(0xFF1E4A2F); // Darker forest green
  static const Color secondaryLight = Color(0xFF8B4513); // Warm saddle brown
  static const Color secondaryVariantLight =
      Color(0xFF6B3410); // Darker saddle brown
  static const Color accentLight = Color(0xFFDAA520); // Goldenrod
  ...
  static const Color successLight = Color(0xFF388E3C); // Medium green
  ...
  // Dark theme colors maintaining spiritual reverence
  static const Color primaryDark = Color(0xFF4A8B6B); // Lighter forest green
  static const Color primaryVariantDark =
      Color(0xFF2C5F41); // Original forest green
  static const Color secondaryDark = Color(0xFFB8651A); // Lighter saddle brown
  static const Color secondaryVariantDark =
      Color(0xFF8B4513); // Original saddle brown
  static const Color accentDark = Color(0xFFE6B84D); // Lighter goldenrod
  ...
  static const Color warningDark = Color(0xFFFF9800); // Lighter amber
  ...
  // Shadow colors for sacred minimalism (subtle depth)
  static const Color shadowLight = Color(0x1E000000); // 0.12 opacity
  static const Color shadowDark = Color(0x1EFFFFFF); // 0.12 opacity

  // Divider colors for structural elements only
  static const Color dividerLight = Color(0x1F212121); // 0.12 opacity
  static const Color dividerDark = Color(0x1FFFFFFF); // 0.12 opacity
  ...
  /// Light theme implementing Sacred Minimalism design principles
  static ThemeData lightTheme = ThemeData(
      ...
      // AppBar with spiritual reverence and clean design
      ...
      // Card theme with minimal elevation for sacred minimalism
      cardTheme: CardTheme(
          color: cardLight,
          elevation: 2.0, // Minimal elevation as per design
          shadowColor: shadowLight,
          shape: RoundedRectangleBorder(
            borderRadius: BorderRadius.circular(12.0), // Gentle curves
          ),
      ...
      // FAB with gradient reserved for primary CTA
      floatingActionButtonTheme: FloatingActionButtonThemeData(
          backgroundColor: accentLight, // Goldenrod for primary actions
          foregroundColor: Color(0xFF000000),
          elevation: 4.0,
          shape: RoundedRectangleBorder(
              borderRadius: BorderRadius.circular(16.0))),

      // Button themes with welcoming reverence
      ...
      // Typography with cultural neutrality and mobile optimization
      textTheme: _buildTextTheme(isLight: true),

      // Input decoration with purposeful spacing
      inputDecorationTheme: InputDecorationTheme(
          ...
          hintStyle: GoogleFonts.inter(
              ...
              fontWeight: FontWeight.w400),
          errorStyle:
              GoogleFonts.inter(color: errorLight, fontSize: 12, fontWeight: FontWeight.w400)),

      // Switch theme with spiritual color harmony
      ...
      tooltipTheme: TooltipThemeData(decoration: BoxDecoration(color: textPrimaryLight.withValues(alpha: 0.9), borderRadius: BorderRadius.circular(8.0)), textStyle: GoogleFonts.inter(color: surfaceLight, fontSize: 12, fontWeight: FontWeight.w400), padding: EdgeInsets.symmetric(horizontal: 12, vertical: 8)),
      ...
      expansionTileTheme: ExpansionTileThemeData(backgroundColor: surfaceLight, collapsedBackgroundColor: surfaceLight, textColor: textPrimaryLight, collapsedTextColor: textPrimaryLight, iconColor: textSecondaryLight, collapsedIconColor: textSecondaryLight, shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(12.0)), collapsedShape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(12.0))), dialogTheme: DialogThemeData(backgroundColor: dialogLight));

  /// Dark theme maintaining spiritual reverence in low-light environments
  static ThemeData darkTheme = ThemeData(
      ...
      inputDecorationTheme: InputDecorationTheme(
          ...
          enabledBorder: OutlineInputBorder(
              ...
              borderSide: BorderSide(color: dividerDark)),
          focusedBorder:
              OutlineInputBorder(borderRadius: BorderRadius.circular(12.0), borderSide: BorderSide(color: primaryDark, width: 2.0)),
      ...
      tooltipTheme: TooltipThemeData(decoration: BoxDecoration(color: textPrimaryDark.withValues(alpha: 0.9), borderRadius: BorderRadius.circular(8.0)), textStyle: GoogleFonts.inter(color: backgroundDark, fontSize: 12, fontWeight: FontWeight.w400), padding: EdgeInsets.symmetric(horizontal: 12, vertical: 8)),
      ...
      expansionTileTheme: ExpansionTileThemeData(backgroundColor: surfaceDark, collapsedBackgroundColor: surfaceDark, textColor: textPrimaryDark, collapsedTextColor: textPrimaryDark, iconColor: textSecondaryDark, collapsedIconColor: textSecondaryDark, shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(12.0)), collapsedShape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(12.0))), dialogTheme: DialogThemeData(backgroundColor: dialogDark));

  /// Helper method to build text theme with Google Fonts for cultural neutrality
  static TextTheme _buildTextTheme({required bool isLight}) {
    ...
    return TextTheme(
        ...
        // Body styles for content - optimized for mobile reading
